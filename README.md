...
남이 든 걸 뺏고 싶으면 아무거나 집어서 **던져 맞히면** 된다. 맞은 사람은 들고 있던 걸 놓친다.
...
함께 깔려 있어서, 급하게 집으면 엉뚱한 걸 들고 당당히 서 있게 된다.

## 방이 사고를 친다

2라운드부터 맵에 따라 사건이 터진다. 캠핑장에서는 **너구리가 물건을 물고 도망친다.**
되찾으려면 던져서 맞혀야 한다.
...
로비에서 자기 **잡기 버튼**을 누르면 참가, `B`로 AI 봇 추가, `R`로 시작한다.
...
개발 과정과 AI 활용 내역은 [AI 활용 기술 문서](docs/AI활용기술문서.md)에,
