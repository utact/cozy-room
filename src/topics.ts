...
/**
 * 콘셉트 2「오토캠핑 데크」— 조명·안전 / 화력·조리 / 분위기·따뜻함 세 축.
 * 거실의 세 축(소중함·소음·포근함)과도 서로와도 겹치지 않는다.
 */
export const CAMPING_TOPICS: Topic[] = [
  {
    text: '한밤중 화장실 갈 때, 안 챙기면 후회하는 건?',
    tagWeights: {
      조명: 42, 안전: 30, 휴대성: 16, 이동: 14, 위생: 10,
      화력: -15, 조리: -20, 따뜻함: -18, 분위기: -10,
    },
  },
  {
    text: '고기 다 탄다! 지금 필요한 건?',
    tagWeights: {
      화력: 40, 조리: 32, 실용: 18, 무거움: 12,
      안전: -12, 조명: -15, 분위기: -20, 따뜻함: -10,
    },
  },
  {
    text: '불멍 타임, 분위기 살릴 필수템은?',
    tagWeights: {
      분위기: 40, 따뜻함: 30, 휴식: 20, 음료: 14, 간식: 14,
      화력: -15, 조리: -18, 안전: -22, 실용: -12,
    },
  },
];
